import{C as e,Fr as t,It as n,Ur as r,h as i,l as a,q as o,wr as s}from"./store-BTp65exn.js";import{d as c}from"./components-C-b7W0HY.js";import{a as l,i as u,o as d}from"./Button-CgkDB36I.js";import{t as f}from"./obj-DWV_HR7P.js";import{t as p}from"./Typography-D9DGGOCL.js";import{t as m}from"./Image-CAXJfQHk.js";import{t as ee}from"./Tooltip-dk9egUjJ.js";import{t as h}from"./Switch-1Mwz6Zp9.js";function g(e){return e&&e.__esModule&&Object.prototype.hasOwnProperty.call(e,`default`)?e.default:e}var _={exports:{}},te=_.exports,v;function ne(){return v?_.exports:(v=1,(function(e,t){(function(t,n){e.exports=n()})(te,function(){function e(t){return(e=typeof Symbol==`function`&&typeof Symbol.iterator==`symbol`?function(e){return typeof e}:function(e){return e&&typeof Symbol==`function`&&e.constructor===Symbol&&e!==Symbol.prototype?`symbol`:typeof e})(t)}var t=Object.prototype.toString,n=function(n){if(n===void 0)return`undefined`;if(n===null)return`null`;var i=e(n);if(i===`boolean`)return`boolean`;if(i===`string`)return`string`;if(i===`number`)return`number`;if(i===`symbol`)return`symbol`;if(i===`function`)return(function(e){return r(e)===`GeneratorFunction`})(n)?`generatorfunction`:`function`;if((function(e){return Array.isArray?Array.isArray(e):e instanceof Array})(n))return`array`;if((function(e){return e.constructor&&typeof e.constructor.isBuffer==`function`?e.constructor.isBuffer(e):!1})(n))return`buffer`;if((function(e){try{if(typeof e.length==`number`&&typeof e.callee==`function`)return!0}catch(e){if(e.message.indexOf(`callee`)!==-1)return!0}return!1})(n))return`arguments`;if((function(e){return e instanceof Date||typeof e.toDateString==`function`&&typeof e.getDate==`function`&&typeof e.setDate==`function`})(n))return`date`;if((function(e){return e instanceof Error||typeof e.message==`string`&&e.constructor&&typeof e.constructor.stackTraceLimit==`number`})(n))return`error`;if((function(e){return e instanceof RegExp||typeof e.flags==`string`&&typeof e.ignoreCase==`boolean`&&typeof e.multiline==`boolean`&&typeof e.global==`boolean`})(n))return`regexp`;switch(r(n)){case`Symbol`:return`symbol`;case`Promise`:return`promise`;case`WeakMap`:return`weakmap`;case`WeakSet`:return`weakset`;case`Map`:return`map`;case`Set`:return`set`;case`Int8Array`:return`int8array`;case`Uint8Array`:return`uint8array`;case`Uint8ClampedArray`:return`uint8clampedarray`;case`Int16Array`:return`int16array`;case`Uint16Array`:return`uint16array`;case`Int32Array`:return`int32array`;case`Uint32Array`:return`uint32array`;case`Float32Array`:return`float32array`;case`Float64Array`:return`float64array`}if((function(e){return typeof e.throw==`function`&&typeof e.return==`function`&&typeof e.next==`function`})(n))return`generator`;switch(i=t.call(n)){case`[object Object]`:return`object`;case`[object Map Iterator]`:return`mapiterator`;case`[object Set Iterator]`:return`setiterator`;case`[object String Iterator]`:return`stringiterator`;case`[object Array Iterator]`:return`arrayiterator`}return i.slice(8,-1).toLowerCase().replace(/\s/g,``)};function r(e){return e.constructor?e.constructor.name:null}function i(e,t){var r=2<arguments.length&&arguments[2]!==void 0?arguments[2]:[`option`];return a(e,t,r),o(e,t,r),(function(e,t,r){var s=n(t),c=n(e);if(s===`object`){if(c!==`object`)throw Error(`[Type Error]: '${r.join(`.`)}' require 'object' type, but got '${c}'`);Object.keys(t).forEach(function(n){var s=e[n],c=t[n],l=r.slice();l.push(n),a(s,c,l),o(s,c,l),i(s,c,l)})}if(s===`array`){if(c!==`array`)throw Error(`[Type Error]: '${r.join(`.`)}' require 'array' type, but got '${c}'`);e.forEach(function(n,s){var c=e[s],l=t[s]||t[0],u=r.slice();u.push(s),a(c,l,u),o(c,l,u),i(c,l,u)})}})(e,t,r),e}function a(e,t,r){if(n(t)===`string`){var i=n(e);if(t[0]===`?`&&(t=t.slice(1)+`|undefined`),!(-1<t.indexOf(`|`)?t.split(`|`).map(function(e){return e.toLowerCase().trim()}).filter(Boolean).some(function(e){return i===e}):t.toLowerCase().trim()===i))throw Error(`[Type Error]: '${r.join(`.`)}' require '${t}' type, but got '${i}'`)}}function o(e,t,r){if(n(t)===`function`){var i=t(e,n(e),r);if(!0!==i){var a=n(i);throw a===`string`?Error(i):a===`error`?i:Error(`[Validator Error]: The scheme for '${r.join(`.`)}' validator require return true, but got '${i}'`)}}}return i.kindOf=n,i})})(_),_.exports)}var y=g(ne()),re=`5.4.0`,b={properties:`audioTracks.autoplay.buffered.controller.controls.crossOrigin.currentSrc.currentTime.defaultMuted.defaultPlaybackRate.duration.ended.error.loop.mediaGroup.muted.networkState.paused.playbackRate.played.preload.readyState.seekable.seeking.src.startDate.textTracks.videoTracks.volume`.split(`.`),methods:[`addTextTrack`,`canPlayType`,`load`,`play`,`pause`],events:[`abort`,`canplay`,`canplaythrough`,`durationchange`,`emptied`,`ended`,`error`,`loadeddata`,`loadedmetadata`,`loadstart`,`pause`,`play`,`playing`,`progress`,`ratechange`,`seeked`,`seeking`,`stalled`,`suspend`,`timeupdate`,`volumechange`,`waiting`],prototypes:[`width`,`height`,`videoWidth`,`videoHeight`,`poster`,`webkitDecodedFrameCount`,`webkitDroppedFrameCount`,`playsInline`,`webkitSupportsFullscreen`,`webkitDisplayingFullscreen`,`onenterpictureinpicture`,`onleavepictureinpicture`,`disablePictureInPicture`,`cancelVideoFrameCallback`,`requestVideoFrameCallback`,`getVideoPlaybackQuality`,`requestPictureInPicture`,`webkitEnterFullScreen`,`webkitEnterFullscreen`,`webkitExitFullScreen`,`webkitExitFullscreen`]},x=globalThis?.CUSTOM_USER_AGENT??(typeof navigator<`u`?navigator.userAgent:``),ie=/^(?:(?!chrome|android).)*safari/i.test(x),ae=/iPad|iPhone|iPod/i.test(x)&&!window.MSStream,oe=ae||x.includes(`Macintosh`)&&navigator.maxTouchPoints>=1,S=/Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(x)||oe,C=typeof window<`u`&&typeof document<`u`;function w(e,t=document){return t.querySelector(e)}function T(e,t=document){return Array.from(t.querySelectorAll(e))}function E(e,t){return e.classList.add(t)}function D(e,t){return e.classList.remove(t)}function O(e,t){return e.classList.contains(t)}function k(e,t){return t instanceof Element?e.appendChild(t):e.insertAdjacentHTML(`beforeend`,String(t)),e.lastElementChild||e.lastChild}function se(e){return e.parentNode.removeChild(e)}function A(e,t,n){return e.style[t]=n,e}function ce(e,t){for(let n in t)A(e,n,t[n]);return e}function le(e,t,n=!0){let r=window.getComputedStyle(e,null).getPropertyValue(t);return n?Number.parseFloat(r):r}function ue(e){return Array.from(e.parentElement.children).filter(t=>t!==e)}function j(e,t){ue(e).forEach(e=>D(e,t)),E(e,t)}function M(e,t,n=`top`){S||(e.setAttribute(`aria-label`,t),E(e,`hint--rounded`),E(e,`hint--${n}`))}function de(e,t=0){let n=e.getBoundingClientRect(),r=window.innerHeight||document.documentElement.clientHeight,i=window.innerWidth||document.documentElement.clientWidth,a=n.top-t<=r&&n.top+n.height+t>=0,o=n.left-t<=i+t&&n.left+n.width+t>=0;return a&&o}function N(e,t){return _e(e).includes(t)}function fe(e,t){return t.parentNode.replaceChild(e,t),e}function P(e){return document.createElement(e)}function pe(e=``,t=``){let n=P(`i`);return E(n,`art-icon`),E(n,`art-icon-${e}`),k(n,t),n}function me(e,t){let n=document.getElementById(e);n||(n=document.createElement(`style`),n.id=e,document.readyState===`loading`?document.addEventListener(`DOMContentLoaded`,()=>{document.head.appendChild(n)}):(document.head||document.documentElement).appendChild(n)),n.textContent=t}function he(){let e=document.createElement(`div`);return e.style.display=`flex`,e.style.display===`flex`}function F(e){return e.getBoundingClientRect()}function ge(e,t){return new Promise((n,r)=>{let i=new Image;i.onload=function(){if(!t||t===1)n(i);else{let a=document.createElement(`canvas`),o=a.getContext(`2d`);a.width=i.width*t,a.height=i.height*t,o.drawImage(i,0,0,a.width,a.height),a.toBlob(t=>{let i=URL.createObjectURL(t),a=new Image;a.onload=function(){n(a)},a.onerror=function(){URL.revokeObjectURL(i),r(Error(`Image load failed: ${e}`))},a.src=i})}},i.onerror=function(){r(Error(`Image load failed: ${e}`))},i.src=e})}function _e(e){if(e.composedPath)return e.composedPath();let t=[],n=e.target;for(;n;)t.push(n),n=n.parentNode;return!t.includes(window)&&window!==void 0&&t.push(window),t}var ve=class extends Error{constructor(e,t){super(e),typeof Error.captureStackTrace==`function`&&Error.captureStackTrace(this,t||this.constructor),this.name=`ArtPlayerError`}};function I(e,t){if(!e)throw new ve(t);return e}function L(e){return e.includes(`?`)?L(e.split(`?`)[0]):e.includes(`#`)?L(e.split(`#`)[0]):e.trim().toLowerCase().split(`.`).pop()}function ye(e,t){let n=document.createElement(`a`);n.style.display=`none`,n.href=e,n.download=t,document.body.appendChild(n),n.click(),document.body.removeChild(n)}function R(e,t,n){return Math.max(Math.min(e,Math.max(t,n)),Math.min(t,n))}function be(e){return e.charAt(0).toUpperCase()+e.slice(1)}function z(e){if(!e)return`00:00`;let t=e=>e<10?`0${e}`:String(e),n=Math.floor(e/3600),r=Math.floor((e-n*3600)/60),i=Math.floor(e-n*3600-r*60);return(n>0?[n,r,i]:[r,i]).map(t).join(`:`)}function xe(e){return e.replace(/[&<>'"]/g,e=>({"&":`&amp;`,"<":`&lt;`,">":`&gt;`,"'":`&#39;`,'"':`&quot;`})[e]||e)}function Se(e){let t={"&amp;":`&`,"&lt;":`<`,"&gt;":`>`,"&#39;":`'`,"&quot;":`"`},n=RegExp(`(${Object.keys(t).join(`|`)})`,`g`);return e.replace(n,e=>t[e]||e)}var B=Object.defineProperty,{hasOwnProperty:Ce}=Object.prototype;function V(e,t){return Ce.call(e,t)}function we(e,t){return Object.getOwnPropertyDescriptor(e,t)}function Te(...e){let t=e=>e&&typeof e==`object`&&!Array.isArray(e);return e.reduce((e,n)=>(Object.keys(n).forEach(r=>{let i=e[r],a=n[r];Array.isArray(i)&&Array.isArray(a)?e[r]=i.concat(...a):t(i)&&t(a)?e[r]=Te(i,a):e[r]=a}),e),{})}function Ee(e){return e.replace(/(\d\d:\d\d:\d\d)[,.](\d+)/g,(e,t,n)=>{let r=n.slice(0,3);return n.length===1&&(r=`${n}00`),n.length===2&&(r=`${n}0`),`${t},${r}`})}function De(e){return`WEBVTT \r
\r
${Ee(e).replace(/\{\\([ibu])\}/g,`</$1>`).replace(/\{\\([ibu])1\}/g,`<$1>`).replace(/\{([ibu])\}/g,`<$1>`).replace(/\{\/([ibu])\}/g,`</$1>`).replace(/(\d\d:\d\d:\d\d),(\d\d\d)/g,`$1.$2`).replace(/\{[\s\S]*?\}/g,``).concat(`\r
\r
`)}`}function Oe(e){return URL.createObjectURL(new Blob([e],{type:`text/vtt`}))}function ke(e){let t=RegExp(`Dialogue:\\s\\d,(\\d+:\\d\\d:\\d\\d.\\d\\d),(\\d+:\\d\\d:\\d\\d.\\d\\d),([^,]*),([^,]*),(?:[^,]*,){4}([\\s\\S]*)$`,`i`);function n(e=``){return e.split(/[:.]/).map((e,t,n)=>{if(t===n.length-1){if(e.length===1)return`.${e}00`;if(e.length===2)return`.${e}0`}else if(e.length===1)return(t===0?`0`:`:0`)+e;return t===0?e:t===n.length-1?`.${e}`:`:${e}`}).join(``)}return`WEBVTT
...
`)}`}function H(e=0){return new Promise(t=>setTimeout(t,e))}function Ae(e,t){let n;return function(...r){clearTimeout(n),n=setTimeout(()=>(n=null,e.apply(this,r)),t)}}function je(e,t){let n=!1;return function(...r){n||(e.apply(this,r),n=!0,setTimeout(()=>{n=!1},t))}}var Me=Object.freeze(Object.defineProperty({__proto__:null,ArtPlayerError:ve,addClass:E,append:k,assToVtt:ke,capitalize:be,clamp:R,createElement:P,debounce:Ae,def:B,download:ye,errorHandle:I,escape:xe,get:we,getComposedPath:_e,getExt:L,getIcon:pe,getRect:F,getStyle:le,has:V,hasClass:O,includeFromEvent:N,inverseClass:j,isBrowser:C,isIOS:ae,isIOS13:oe,isInViewport:de,isMobile:S,isSafari:ie,loadImg:ge,mergeDeep:Te,query:w,queryAll:T,remove:se,removeClass:D,replaceElement:fe,secondToTime:z,setStyle:A,setStyleText:me,setStyles:ce,siblings:ue,sleep:H,srtToVtt:De,supportsFlex:he,throttle:je,tooltip:M,unescape:Se,userAgent:x,vttToBlob:Oe},Symbol.toStringTag,{value:`Module`})),Ne=`array`,U=`boolean`,W=`string`,G=`number`,K=`object`,q=`function`;function Pe(e,t,n){return I(t===W||t===G||e instanceof Element,`${n.join(`.`)} require '${W}' or 'Element' type`)}var J={html:Pe,disable:`?${U}`,name:`?${W}`,index:`?${G}`,style:`?${K}`,click:`?${q}`,mounted:`?${q}`,tooltip:`?${W}|${G}`,width:`?${G}`,selector:`?${Ne}`,onSelect:`?${q}`,switch:`?${U}`,onSwitch:`?${q}`,range:`?${Ne}`,onRange:`?${q}`,onChange:`?${q}`},Fe={id:W,container:Pe,url:W,poster:W,type:W,theme:W,lang:W,volume:G,isLive:U,muted:U,autoplay:U,autoSize:U,autoMini:U,loop:U,flip:U,playbackRate:U,aspectRatio:U,screenshot:U,setting:U,hotkey:U,pip:U,mutex:U,backdrop:U,fullscreen:U,fullscreenWeb:U,subtitleOffset:U,miniProgressBar:U,useSSR:U,playsInline:U,lock:U,gesture:U,fastForward:U,autoPlayback:U,autoOrientation:U,airplay:U,proxy:`?${q}`,plugins:[q],layers:[J],contextmenu:[J],settings:[J],controls:[{...J,position:(e,t,n)=>{let r=[`top`,`left`,`right`];return I(r.includes(e),`${n.join(`.`)} only accept ${r.toString()} as parameters`)}}],quality:[{default:`?${U}`,html:W,url:W}],highlight:[{time:G,text:W}],thumbnails:{url:W,number:G,column:G,width:G,height:G,scale:G},subtitle:{url:W,name:W,type:W,style:K,escape:U,encoding:W,onVttLoad:q},moreVideoAttr:K,i18n:K,icons:K,cssVar:K,customType:K},Y=class{constructor(e){this.id=0,this.art=e,this.cache=new Map,this.add=this.add.bind(this),this.remove=this.remove.bind(this),this.update=this.update.bind(this)}get show(){return O(this.art.template.$player,`art-${this.name}-show`)}set show(e){let{$player:t}=this.art.template,n=`art-${this.name}-show`;e?E(t,n):D(t,n),this.art.emit(this.name,e)}toggle(){this.show=!this.show}add(e){let t=typeof e==`function`?e(this.art):e;if(t.html=t.html||``,y(t,J),!this.$parent||!this.name||t.disable)return;let n=t.name||`${this.name}${this.id}`;I(!this.cache.has(n),`Can't add an existing [${n}] to the [${this.name}]`),this.id+=1;let r=P(`div`);E(r,`art-${this.name}`),E(r,`art-${this.name}-${n}`);let i=Array.from(this.$parent.children);r.dataset.index=t.index||this.id;let a=i.find(e=>Number(e.dataset.index)>=Number(r.dataset.index));a?a.insertAdjacentElement(`beforebegin`,r):k(this.$parent,r),t.html&&k(r,t.html),t.style&&ce(r,t.style),t.tooltip&&M(r,t.tooltip);let o=[];if(t.click){let e=this.art.events.proxy(r,`click`,e=>{e.preventDefault(),t.click.call(this.art,this,e)});o.push(e)}return t.selector&&[`left`,`right`].includes(t.position)&&this.selector(t,r,o),this[n]=r,this.cache.set(n,{$ref:r,events:o,option:t}),t.mounted&&t.mounted.call(this.art,r),r}remove(e){I(this.cache.has(e),`Can't find [${e}] from the [${this.name}]`);let t=this.cache.get(e);t.option.beforeUnmount&&t.option.beforeUnmount.call(this.art,t.$ref);for(let e of t.events)this.art.events.remove(e);this.cache.delete(e),delete this[e],se(t.$ref)}update(e){if(this.cache.has(e.name)){let t=this.cache.get(e.name);e=Object.assign(t.option,e),this.remove(e.name)}return this.add(e)}};function Ie(e){return t=>{let{i18n:n,constructor:{ASPECT_RATIO:r}}=t,i=r.map(e=>`<span data-value="${e}">${e==="default"?n.get(`Default`):e}</span>`).join(``);return{...e,html:`${n.get(`Aspect Ratio`)}: ${i}`,click:(e,n)=>{let{value:r}=n.target.dataset;r&&(t.aspectRatio=r,e.show=!1)},mounted:e=>{let n=w(`[data-value="default"]`,e);n&&j(n,`art-current`),t.on(`aspectRatio`,t=>{let n=T(`span`,e).find(e=>e.dataset.value===t);n&&j(n,`art-current`)})}}}}function Le(e){return t=>({...e,html:t.i18n.get(`Close`),click:e=>{e.show=!1}})}function Re(e){return t=>{let{i18n:n,constructor:{FLIP:r}}=t,i=r.map(e=>`<span data-value="${e}">${n.get(be(e))}</span>`).join(``);return{...e,html:`${n.get(`Video Flip`)}: ${i}`,click:(e,n)=>{let{value:r}=n.target.dataset;r&&(t.flip=r.toLowerCase(),e.show=!1)},mounted:e=>{let n=w(`[data-value="normal"]`,e);n&&j(n,`art-current`),t.on(`flip`,t=>{let n=T(`span`,e).find(e=>e.dataset.value===t);n&&j(n,`art-current`)})}}}}function ze(e){return t=>({...e,html:t.i18n.get(`Video Info`),click:e=>{t.info.show=!0,e.show=!1}})}function Be(e){return t=>{let{i18n:n,constructor:{PLAYBACK_RATE:r}}=t,i=r.map(e=>`<span data-value="${e}">${e===1?n.get(`Normal`):e.toFixed(1)}</span>`).join(``);return{...e,html:`${n.get(`Play Speed`)}: ${i}`,click:(e,n)=>{let{value:r}=n.target.dataset;r&&(t.playbackRate=Number(r),e.show=!1)},mounted:e=>{let n=w(`[data-value="1"]`,e);n&&j(n,`art-current`),t.on(`video:ratechange`,()=>{let n=T(`span`,e).find(e=>Number(e.dataset.value)===t.playbackRate);n&&j(n,`art-current`)})}}}}function Ve(e){let t=C?location.href:``;return{...e,html:`<a href="https://artplayer.org?ref=${encodeURIComponent(t)}" target="_blank" style="width:100%;">ArtPlayer ${re}</a>`}}var He=class extends Y{constructor(e){super(e),this.name=`contextmenu`,this.$parent=e.template.$contextmenu,S||this.init()}init(){let{option:e,proxy:t,template:{$player:n,$contextmenu:r}}=this.art;e.playbackRate&&this.add(Be({name:`playbackRate`,index:10})),e.aspectRatio&&this.add(Ie({name:`aspectRatio`,index:20})),e.flip&&this.add(Re({name:`flip`,index:30})),this.add(ze({name:`info`,index:40})),this.add(Ve({name:`version`,index:50})),this.add(Le({name:`close`,index:60}));for(let t=0;t<e.contextmenu.length;t++)this.add(e.contextmenu[t]);t(n,`contextmenu`,e=>{if(!this.art.constructor.CONTEXTMENU)return;e.preventDefault(),this.show=!0;let t=e.clientX,i=e.clientY,{height:a,width:o,left:s,top:c}=F(n),{height:l,width:u}=F(r),d=t-s,f=i-c;t+u>s+o&&(d=o-u),i+l>c+a&&(f=a-l),ce(r,{top:`${f}px`,left:`${d}px`})}),t(n,`click`,e=>{N(e,r)||(this.show=!1)}),this.art.on(`blur`,()=>{this.show=!1})}};function Ue(e){return t=>({...e,tooltip:t.i18n.get(`AirPlay`),mounted:e=>{let{proxy:n,icons:r}=t;k(e,r.airplay),n(e,`click`,()=>t.airplay())}})}function We(e){return t=>({...e,tooltip:t.i18n.get(`Fullscreen`),mounted:e=>{let{proxy:n,icons:r,i18n:i}=t,a=k(e,r.fullscreenOn),o=k(e,r.fullscreenOff);A(o,`display`,`none`),n(e,`click`,()=>{t.fullscreen=!t.fullscreen}),t.on(`fullscreen`,t=>{t?(M(e,i.get(`Exit Fullscreen`)),A(a,`display`,`none`),A(o,`display`,`inline-flex`)):(M(e,i.get(`Fullscreen`)),A(a,`display`,`inline-flex`),A(o,`display`,`none`))})}})}function Ge(e){return t=>({...e,tooltip:t.i18n.get(`Web Fullscreen`),mounted:e=>{let{proxy:n,icons:r,i18n:i}=t,a=k(e,r.fullscreenWebOn),o=k(e,r.fullscreenWebOff);A(o,`display`,`none`),n(e,`click`,()=>{t.fullscreenWeb=!t.fullscreenWeb}),t.on(`fullscreenWeb`,t=>{t?(M(e,i.get(`Exit Web Fullscreen`)),A(a,`display`,`none`),A(o,`display`,`inline-flex`)):(M(e,i.get(`Web Fullscreen`)),A(a,`display`,`inline-flex`),A(o,`display`,`none`))})}})}function Ke(e){return t=>({...e,tooltip:t.i18n.get(`PIP Mode`),mounted:e=>{let{proxy:n,icons:r,i18n:i}=t;k(e,r.pip),n(e,`click`,()=>{t.pip=!t.pip}),t.on(`pip`,t=>{M(e,i.get(t?`Exit PIP Mode`:`PIP Mode`))})}})}function qe(e){return t=>({...e,mounted:e=>{let{proxy:n,icons:r,i18n:i}=t,a=k(e,r.play),o=k(e,r.pause);M(a,i.get(`Play`)),M(o,i.get(`Pause`)),n(a,`click`,()=>{t.play()}),n(o,`click`,()=>{t.pause()});function s(){A(a,`display`,`flex`),A(o,`display`,`none`)}function c(){A(a,`display`,`none`),A(o,`display`,`flex`)}t.playing?c():s(),t.on(`video:playing`,()=>{c()}),t.on(`video:pause`,()=>{s()})}})}function X(e,t){let{$progress:n}=e.template,{left:r}=F(n),i=R((S?t.touches[0].clientX:t.clientX)-r,0,n.clientWidth),a=i/n.clientWidth*e.duration;return{second:a,time:z(a),width:i,percentage:R(i/n.clientWidth,0,1)}}function Je(e,t){if(e.isRotate){let n=t.touches[0].clientY/e.height,r=n*e.duration;e.emit(`setBar`,`played`,n,t),e.seek=r}else{let{second:n,percentage:r}=X(e,t);e.emit(`setBar`,`played`,r,t),e.seek=n}}function Ye(e){return t=>{let{icons:n,option:r,proxy:i}=t,{$player:a,$progress:o}=t.template;return{...e,html:`
            ...
            `,mounted:e=>{let s=null,c=!1,l=w(`.art-progress-hover`,e),u=w(`.art-progress-loaded`,e),d=w(`.art-progress-played`,e),f=w(`.art-progress-highlight`,e),p=w(`.art-progress-indicator`,e),m=w(`.art-progress-tip`,e);n.indicator?k(p,n.indicator):A(p,`backgroundColor`,`var(--art-theme)`);function ee(n){let{width:r}=X(t,n),{text:i}=n.target.dataset;m.textContent=i;let a=m.clientWidth;r<=a/2?A(m,`left`,0):r>e.clientWidth-a/2?A(m,`left`,`${e.clientWidth-a}px`):A(m,`left`,`${r-a/2}px`)}function h(n,r){let{width:i,time:a}=r||X(t,n);m.textContent=a||`00:00`;let o=m.clientWidth;i<=o/2?A(m,`left`,0):i>e.clientWidth-o/2?A(m,`left`,`${e.clientWidth-o}px`):A(m,`left`,`${i-o/2}px`)}function g(){f.textContent=``;for(let e=0;e<r.highlight.length;e++){let n=r.highlight[e],i=R(n.time,0,t.duration)/t.duration*100,a=`<span data-text="${n.text}" data-time="${n.time}" style="left: ${i}%"></span>`;k(f,a)}}function _(n,r,i){let o=n===`played`&&i&&S;n===`loaded`&&A(u,`width`,`${r*100}%`),n===`hover`&&(A(l,`width`,`${r*100}%`),N(i,f)?ee(i):h(i),r===0?D(a,`art-progress-hover`):E(a,`art-progress-hover`)),n===`played`&&(A(d,`width`,`${r*100}%`),A(p,`left`,`${r*100}%`)),o&&(E(a,`art-progress-hover`),h(i,{width:e.clientWidth*r,time:z(r*t.duration)}),clearTimeout(s),s=setTimeout(()=>{D(a,`art-progress-hover`)},500))}t.on(`setBar`,_),t.on(`video:loadedmetadata`,g),t.constructor.USE_RAF?t.on(`raf`,()=>{t.emit(`setBar`,`played`,t.played),t.emit(`setBar`,`loaded`,t.loaded)}):(t.on(`video:timeupdate`,()=>{t.emit(`setBar`,`played`,t.played)}),t.on(`video:progress`,()=>{t.emit(`setBar`,`loaded`,t.loaded)}),t.on(`video:ended`,()=>{t.emit(`setBar`,`played`,1)})),t.emit(`setBar`,`loaded`,t.loaded||0),S||(i(o,`click`,e=>{e.target!==p&&Je(t,e)}),i(o,`mousemove`,e=>{let{percentage:n}=X(t,e);t.emit(`setBar`,`hover`,n,e)}),i(o,`mouseleave`,e=>{t.emit(`setBar`,`hover`,0,e)}),i(o,`mousedown`,e=>{c=e.button===0}),t.on(`document:mousemove`,e=>{if(c){let{second:n,percentage:r}=X(t,e);t.emit(`setBar`,`played`,r,e),t.seek=n}}),t.on(`document:mouseup`,()=>{c&&(c=!1)}))}}}}function Xe(e){return t=>({...e,tooltip:t.i18n.get(`Screenshot`),mounted:e=>{let{proxy:n,icons:r}=t;k(e,r.screenshot),n(e,`click`,()=>{t.screenshot()})}})}function Ze(e){return t=>({...e,tooltip:t.i18n.get(`Show Setting`),mounted:e=>{let{proxy:n,icons:r,i18n:i}=t;k(e,r.setting),n(e,`click`,()=>{t.setting.toggle(),t.setting.resize()}),t.on(`setting`,t=>{M(e,i.get(t?`Hide Setting`:`Show Setting`))})}})}function Qe(e){return t=>({...e,style:S?{fontSize:`12px`,padding:`0 5px`}:{cursor:`auto`,padding:`0 10px`},mounted:e=>{function n(){let n=`${z(t.currentTime)} / ${z(t.duration)}`;n!==e.textContent&&(e.textContent=n)}n();let r=[`video:loadedmetadata`,`video:timeupdate`,`video:progress`];for(let e=0;e<r.length;e++)t.on(r[e],n)}})}function $e(e){return t=>({...e,mounted:e=>{let{proxy:n,icons:r}=t,i=k(e,r.volume),a=k(e,r.volumeClose),o=k(e,`<div class="art-volume-panel"></div>`),s=k(o,`<div class="art-volume-inner"></div>`),c=k(s,`<div class="art-volume-val"></div>`),l=k(s,`<div class="art-volume-slider"></div>`),u=k(k(l,`<div class="art-volume-handle"></div>`),`<div class="art-volume-loaded"></div>`),d=k(l,`<div class="art-volume-indicator"></div>`);function f(e){let{top:t,height:n}=F(l);return 1-(e.clientY-t)/n}function p(){if(t.muted||t.volume===0)A(i,`display`,`none`),A(a,`display`,`flex`),A(d,`top`,`100%`),A(u,`top`,`100%`),c.textContent=0;else{let e=t.volume*100;A(i,`display`,`flex`),A(a,`display`,`none`),A(d,`top`,`${100-e}%`),A(u,`top`,`${100-e}%`),c.textContent=Math.floor(e)}}if(p(),t.on(`video:volumechange`,p),n(i,`click`,()=>{t.muted=!0}),n(a,`click`,()=>{t.muted=!1}),S)A(o,`display`,`none`);else{let e=!1;n(l,`mousedown`,n=>{e=n.button===0,t.volume=f(n)}),t.on(`document:mousemove`,n=>{e&&(t.muted=!1,t.volume=f(n))}),t.on(`document:mouseup`,()=>{e&&(e=!1)})}}})}var et=class extends Y{constructor(e){super(e),this.isHover=!1,this.name=`control`,this.timer=Date.now();let{constructor:t}=e,{$player:n,$bottom:r}=this.art.template;e.on(`mousemove`,()=>{S||(this.show=!0)}),e.on(`click`,()=>{S?this.toggle():this.show=!0}),e.on(`document:mousemove`,e=>{this.isHover=N(e,r)}),e.on(`video:timeupdate`,()=>{!e.setting.show&&!this.isHover&&!e.isInput&&e.playing&&this.show&&Date.now()-this.timer>=t.CONTROL_HIDE_TIME&&(this.show=!1)}),e.on(`control`,e=>{e?(D(n,`art-hide-cursor`),E(n,`art-hover`),this.timer=Date.now()):(E(n,`art-hide-cursor`),D(n,`art-hover`))}),this.init()}init(){let{option:e}=this.art;e.isLive||this.add(Ye({name:`progress`,position:`top`,index:10})),this.add({name:`thumbnails`,position:`top`,index:20}),this.add(qe({name:`playAndPause`,position:`left`,index:10})),this.add($e({name:`volume`,position:`left`,index:20})),e.isLive||this.add(Qe({name:`time`,position:`left`,index:30})),e.quality.length&&H().then(()=>{this.art.quality=e.quality}),e.screenshot&&!S&&this.add(Xe({name:`screenshot`,position:`right`,index:20})),e.setting&&this.add(Ze({name:`setting`,position:`right`,index:30})),e.pip&&this.add(Ke({name:`pip`,position:`right`,index:40})),e.airplay&&window.WebKitPlaybackTargetAvailabilityEvent&&this.add(Ue({name:`airplay`,position:`right`,index:50})),e.fullscreenWeb&&this.add(Ge({name:`fullscreenWeb`,position:`right`,index:60})),e.fullscreen&&this.add(We({name:`fullscreen`,position:`right`,index:70}));for(let t=0;t<e.controls.length;t++)this.add(e.controls[t])}add(e){let t=typeof e==`function`?e(this.art):e,{$progress:n,$controlsLeft:r,$controlsRight:i}=this.art.template;switch(t.position){case`top`:this.$parent=n;break;case`left`:this.$parent=r;break;case`right`:this.$parent=i;break;default:I(!1,`Control option.position must one of 'top', 'left', 'right'`);break}super.add(t)}check(e){if(e){e.$control_value.innerHTML=e.html;for(let t=0;t<e.$control_option.length;t++){let n=e.$control_option[t];n.default=n===e,n.default&&j(n.$control_item,`art-current`)}}}selector(e,t,n){let{proxy:r}=this.art.events;E(t,`art-control-selector`);let i=P(`div`);E(i,`art-selector-value`),k(i,e.html),t.textContent=``,k(t,i);let a=P(`div`);E(a,`art-selector-list`),k(t,a);for(let t=0;t<e.selector.length;t++){let n=e.selector[t],r=P(`div`);E(r,`art-selector-item`),n.default&&E(r,`art-current`),r.dataset.index=t,r.dataset.value=n.value,r.innerHTML=n.html,k(a,r),B(n,`$control_option`,{get:()=>e.selector}),B(n,`$control_item`,{get:()=>r}),B(n,`$control_value`,{get:()=>i})}let o=r(a,`click`,async t=>{let n=_e(t),r=e.selector.find(e=>e.$control_item===n.find(t=>e.$control_item===t));this.check(r),e.onSelect&&(i.innerHTML=await e.onSelect.call(this.art,r,r.$control_item,t))});n.push(o)}};function tt(e,t){let{constructor:n,template:{$player:r,$video:i}}=e;function a(t){N(t,r)?(e.isInput=t.target.tagName===`INPUT`,e.isFocus=!0,e.emit(`focus`,t)):(e.isInput=!1,e.isFocus=!1,e.emit(`blur`,t))}e.on(`document:click`,a),e.on(`document:contextmenu`,a);let o=[];t.proxy(i,`click`,t=>{let r=Date.now();o.push(r);let{MOBILE_CLICK_PLAY:i,DBCLICK_TIME:a,MOBILE_DBCLICK_PLAY:s,DBCLICK_FULLSCREEN:c}=n,l=o.filter(e=>r-e<=a);switch(l.length){case 1:e.emit(`click`,t),S?!e.isLock&&i&&e.toggle():e.toggle(),o=l;break;case 2:e.emit(`dblclick`,t),S?!e.isLock&&s&&e.toggle():c&&(e.fullscreen=!e.fullscreen),o=[];break;default:o=[]}})}function nt(e,t){return Math.atan2(t,e)*180/Math.PI}function rt(e,t,n,r){let i=t-r,a=n-e,o=0;if(Math.abs(a)<2&&Math.abs(i)<2)return o;let s=nt(a,i);return s>=-45&&s<45?o=4:s>=45&&s<135?o=1:s>=-135&&s<-45?o=2:(s>=135&&s<=180||s>=-180&&s<-135)&&(o=3),o}function it(e,t){if(S&&!e.option.isLive){let{$video:n,$progress:r}=e.template,i=null,a=!1,o=0,s=0,c=0,l=t=>{if(t.touches.length===1&&!e.isLock){i===r&&Je(e,t),a=!0;let{pageX:n,pageY:l}=t.touches[0];o=n,s=l,c=e.currentTime}},u=t=>{if(t.touches.length===1&&a&&e.duration){let{pageX:r,pageY:a}=t.touches[0],l=rt(o,s,r,a),u=[3,4].includes(l),d=[1,2].includes(l);if(u&&!e.isRotate||d&&e.isRotate){let l=R((r-o)/e.width,-1,1),u=R((a-s)/e.height,-1,1),d=e.isRotate?u:l,f=i===n?e.constructor.TOUCH_MOVE_RATIO:1,p=R(c+e.duration*d*f,0,e.duration);e.seek=p,e.emit(`setBar`,`played`,R(p/e.duration,0,1),t),e.notice.show=`${z(p)} / ${z(e.duration)}`}}};e.option.gesture&&(t.proxy(n,`touchstart`,e=>{i=n,l(e)}),t.proxy(n,`touchmove`,u)),t.proxy(r,`touchstart`,e=>{i=r,l(e)}),t.proxy(r,`touchmove`,u),e.on(`document:touchend`,()=>{a&&(o=0,s=0,c=0,a=!1,i=null)})}}function at(e,t){let n=[`click`,`mouseup`,`keydown`,`touchend`,`touchmove`,`mousemove`,`pointerup`,`contextmenu`,`pointermove`,`visibilitychange`,`webkitfullscreenchange`],r=[`resize`,`scroll`,`orientationchange`],i=[];function a(a={}){for(let e=0;e<i.length;e++)t.remove(i[e]);i.length=0;let{$player:o}=e.template;n.forEach(n=>{let r=a.document||o.ownerDocument||document,s=t.proxy(r,n,t=>{e.emit(`document:${n}`,t)});i.push(s)}),r.forEach(n=>{let r=a.window||o.ownerDocument?.defaultView||window,s=t.proxy(r,n,t=>{e.emit(`window:${n}`,t)});i.push(s)})}a(),t.bindGlobalEvents=a}function ot(e,t){let{$player:n}=e.template;t.hover(n,t=>{E(n,`art-hover`),e.emit(`hover`,!0,t)},t=>{D(n,`art-hover`),e.emit(`hover`,!1,t)})}function st(e,t){let{$player:n}=e.template;t.proxy(n,`mousemove`,t=>{e.emit(`mousemove`,t)})}function ct(e,t){let{option:n,constructor:r}=e;e.on(`resize`,()=>{let{aspectRatio:t,notice:r}=e;e.state===`standard`&&n.autoSize&&e.autoSize(),e.aspectRatio=t,r.show=``});let i=Ae(()=>e.emit(`resize`),r.RESIZE_TIME);e.on(`window:orientationchange`,()=>i()),e.on(`window:resize`,()=>i()),screen&&screen.orientation&&screen.orientation.onchange&&t.proxy(screen.orientation,`change`,()=>i())}function lt(e){if(e.constructor.USE_RAF){let t=null;(function n(){e.playing&&e.emit(`raf`),e.isDestroy||(t=requestAnimationFrame(n))})(),e.on(`destroy`,()=>{cancelAnimationFrame(t)})}}function ut(e){let{option:t,constructor:n,template:{$container:r}}=e,i=je(()=>{e.emit(`view`,de(r,n.SCROLL_GAP))},n.SCROLL_TIME);e.on(`window:scroll`,()=>i()),e.on(`view`,n=>{t.autoMini&&(e.mini=!n)})}var dt=class{constructor(e){this.destroyEvents=new Set,this.proxy=this.proxy.bind(this),this.hover=this.hover.bind(this),tt(e,this),ot(e,this),st(e,this),ct(e,this),it(e,this),ut(e),at(e,this),lt(e)}proxy(e,t,n,r={}){if(Array.isArray(t))return t.map(t=>this.proxy(e,t,n,r));e.addEventListener(t,n,r);let i=()=>e.removeEventListener(t,n,r);return this.destroyEvents.add(i),i}hover(e,t,n){t&&this.proxy(e,`mouseenter`,t),n&&this.proxy(e,`mouseleave`,n)}remove(e){if(this.destroyEvents.has(e))try{e()}catch(e){console.warn(`Failed to remove event listener:`,e)}finally{this.destroyEvents.delete(e)}}destroy(){for(let e of this.destroyEvents)try{e()}catch(e){console.warn(`Failed to destroy event listener:`,e)}this.destroyEvents.clear()}},ft=class{constructor(e){this.art=e,this.keys={},S||this.init()}init(){let{constructor:e}=this.art;this.art.option.hotkey&&(this.add(`Escape`,()=>{this.art.fullscreenWeb&&(this.art.fullscreenWeb=!1)}),this.add(`Space`,()=>{this.art.toggle()}),this.add(`ArrowLeft`,()=>{this.art.backward=e.SEEK_STEP}),this.add(`ArrowUp`,()=>{this.art.volume+=e.VOLUME_STEP}),this.add(`ArrowRight`,()=>{this.art.forward=e.SEEK_STEP}),this.add(`ArrowDown`,()=>{this.art.volume-=e.VOLUME_STEP})),this.art.on(`document:keydown`,e=>{if(this.art.isFocus){let t=document.activeElement.tagName.toUpperCase(),n=document.activeElement.getAttribute(`contenteditable`);if(t!==`INPUT`&&t!==`TEXTAREA`&&n!==``&&n!==`true`&&!e.altKey&&!e.ctrlKey&&!e.metaKey&&!e.shiftKey){let t=this.keys[e.code];if(t){e.preventDefault();for(let n=0;n<t.length;n++)t[n].call(this.art,e);this.art.emit(`hotkey`,e)}}}this.art.emit(`keydown`,e)})}add(e,t){return this.keys[e]?this.keys[e].includes(t)||this.keys[e].push(t):this.keys[e]=[t],this}remove(e,t){if(this.keys[e]){let n=this.keys[e].indexOf(t);n!==-1&&this.keys[e].splice(n,1),this.keys[e].length===0&&delete this.keys[e]}return this}},pt={"Video Info":`统计信息`,Close:`关闭`,"Video Load Failed":`加载失败`,Volume:`音量`,Play:`播放`,Pause:`暂停`,Rate:`速度`,Mute:`静音`,"Video Flip":`画面翻转`,Horizontal:`水平`,Vertical:`垂直`,Reconnect:`重新连接`,"Show Setting":`显示设置`,"Hide Setting":`隐藏设置`,Screenshot:`截图`,"Play Speed":`播放速度`,"Aspect Ratio":`画面比例`,Default:`默认`,Normal:`正常`,Open:`打开`,"Switch Video":`切换`,"Switch Subtitle":`切换字幕`,Fullscreen:`全屏`,"Exit Fullscreen":`退出全屏`,"Web Fullscreen":`网页全屏`,"Exit Web Fullscreen":`退出网页全屏`,"Mini Player":`迷你播放器`,"PIP Mode":`开启画中画`,"Exit PIP Mode":`退出画中画`,"PIP Not Supported":`不支持画中画`,"Fullscreen Not Supported":`不支持全屏`,"Subtitle Offset":`字幕偏移`,"Last Seen":`上次看到`,"Jump Play":`跳转播放`,AirPlay:`隔空播放`,"AirPlay Not Available":`隔空播放不可用`};typeof window<`u`&&(window[`artplayer-i18n-zh-cn`]=pt);var mt=class{constructor(e){this.art=e,this.languages={"zh-cn":pt},this.language={},this.update(e.option.i18n)}init(){let e=this.art.option.lang.toLowerCase();this.language=this.languages[e]||{}}get(e){return this.language[e]||e}update(e){this.languages=Te(this.languages,e),this.init()}},ht=`<svg width="18px" height="18px" viewBox="0 0 18 18" xmlns="http://www.w3.org/2000/svg">
    <g>
...
</svg>`,xt=`<svg height="24" viewBox="0 0 24 24" width="24"><path d="M15,17h6v1h-6V17z M11,17H3v1h8v2h1v-2v-1v-2h-1V17z M14,8h1V6V5V3h-1v2H3v1h11V8z            M18,5v1h3V5H18z M6,14h1v-2v-1V9H6v2H3v1 h3V14z M10,12h11v-1H10V12z" data-darkreader-inline-fill="" style="--darkreader-inline-fill:#a8a6a4;"></path></svg>`,St=`<?xml version="1.0" standalone="no"?>
<!DOCTYPE svg PUBLIC "-//W3C//DTD SVG 1.1//EN" "http://www.w3.org/Graphics/SVG/1.1/DTD/svg11.dtd">
...
`,wt=`<?xml version="1.0" standalone="no"?>
<!DOCTYPE svg PUBLIC "-//W3C//DTD SVG 1.1//EN" "http://www.w3.org/Graphics/SVG/1.1/DTD/svg11.dtd">
...
`,Ot=`<svg xmlns="http://www.w3.org/2000/svg" width="50px" height="50px" viewBox="0 0 100 100" preserveAspectRatio="xMidYMid" class="uil-default">
...
</svg>`,kt=`<?xml version="1.0" standalone="no"?>
<!DOCTYPE svg PUBLIC "-//W3C//DTD SVG 1.1//EN" "http://www.w3.org/Graphics/SVG/1.1/DTD/svg11.dtd">
...
`,At=`<svg xmlns="http://www.w3.org/2000/svg" height="22" width="22" viewBox="0 0 22 22">
    <path d="M7 3a2 2 0 0 0-2 2v12a2 2 0 1 0 4 0V5a2 2 0 0 0-2-2zM15 3a2 2 0 0 0-2 2v12a2 2 0 1 0 4 0V5a2 2 0 0 0-2-2z"></path>
</svg>`,jt=`<svg viewBox="0 0 1024 1024" xmlns="http://www.w3.org/2000/svg" width="22" height="22">
...
</svg>`,Mt=`<svg xmlns="http://www.w3.org/2000/svg" height="22" width="22" viewBox="0 0 22 22">
  <path d="M17.982 9.275L8.06 3.27A2.013 2.013 0 0 0 5 4.994v12.011a2.017 2.017 0 0 0 3.06 1.725l9.922-6.005a2.017 2.017 0 0 0 0-3.45z"></path>
</svg>`,Nt=`<svg height="24" viewBox="0 0 24 24" width="24"><path d="M10,8v8l6-4L10,8L10,8z M6.3,5L5.7,4.2C7.2,3,9,2.2,11,2l0.1,1C9.3,3.2,7.7,3.9,6.3,5z            M5,6.3L4.2,5.7C3,7.2,2.2,9,2,11 l1,.1C3.2,9.3,3.9,7.7,5,6.3z            M5,17.7c-1.1-1.4-1.8-3.1-2-4.8L2,13c0.2,2,1,3.8,2.2,5.4L5,17.7z            M11.1,21c-1.8-0.2-3.4-0.9-4.8-2 l-0.6,.8C7.2,21,9,21.8,11,22L11.1,21z            M22,12c0-5.2-3.9-9.4-9-10l-0.1,1c4.6,.5,8.1,4.3,8.1,9s-3.5,8.5-8.1,9l0.1,1 C18.2,21.5,22,17.2,22,12z" data-darkreader-inline-fill="" style="--darkreader-inline-fill:#a8a6a4;"></path></svg>`,Pt=`<svg xmlns="http://www.w3.org/2000/svg" height="22" width="22" viewBox="0 0 50 50">
...
`,Ft=`<svg xmlns="http://www.w3.org/2000/svg" height="22" width="22" viewBox="0 0 22 22">
...
</svg>`,It=`<svg xmlns="http://www.w3.org/2000/svg" width="80" height="80" viewBox="0 0 24 24">
...
`,Jn=class extends Y{constructor(e){super(e),this.name=`subtitle`,this.option=null,this.destroyEvent=()=>null,this.init(e.option.subtitle);let t=!1;e.on(`video:timeupdate`,()=>{if(!this.url)return;let e=this.art.template.$video.webkitDisplayingFullscreen;typeof e==`boolean`&&e!==t&&(t=e,this.createTrack(e?`subtitles`:`metadata`,this.url))})}get url(){return this.art.template.$track.src}set url(e){this.switch(e)}get textTrack(){return this.art.template.$video?.textTracks?.[0]}get activeCues(){return this.textTrack?Array.from(this.textTrack.activeCues):[]}get cues(){return this.textTrack?Array.from(this.textTrack.cues):[]}style(e,t){let{$subtitle:n}=this.art.template;return typeof e==`object`?ce(n,e):A(n,e,t)}update(){let{option:{subtitle:e},template:{$subtitle:t}}=this.art;t.innerHTML=``,this.activeCues.length&&(this.art.emit(`subtitleBeforeUpdate`,this.activeCues),t.innerHTML=this.activeCues.map((t,n)=>t.text.split(/\r?\n/).filter(e=>e.trim()).map(t=>`<div class="art-subtitle-line" data-group="${n}">
                                ${e.escape?xe(t):t}
                            </div>`).join(``)).join(``),this.art.emit(`subtitleAfterUpdate`,this.activeCues))}async switch(e,t={}){let{i18n:n,notice:r,option:i}=this.art,a={...i.subtitle,...t,url:e},o=await this.init(a);return t.name&&(r.show=`${n.get(`Switch Subtitle`)}: ${t.name}`),o}createTrack(e,t){let{template:n,proxy:r,option:i}=this.art,{$video:a,$track:o}=n,s=P(`track`);s.default=!0,s.kind=e,s.src=t,s.label=i.subtitle.name||`Artplayer`,s.track.mode=`hidden`,s.onload=()=>{this.art.emit(`subtitleLoad`,this.cues,this.option)},this.art.events.remove(this.destroyEvent),o.onload=null,se(o),k(a,s),n.$track=s,this.destroyEvent=r(this.textTrack,`cuechange`,()=>this.update())}async init(e){let{notice:t,template:{$subtitle:n}}=this.art;if(!this.textTrack)return null;if(y(e,Fe.subtitle),e.url)return this.option=e,this.style(e.style),fetch(e.url).then(e=>e.arrayBuffer()).then(t=>{let n=new TextDecoder(e.encoding).decode(t);switch(e.type||L(e.url)){case`srt`:{let t=De(n);return Oe(e.onVttLoad(t))}case`ass`:{let t=ke(n);return Oe(e.onVttLoad(t))}case`vtt`:return Oe(e.onVttLoad(n));default:return e.url}}).then(e=>(n.innerHTML=``,this.url===e?e:(URL.revokeObjectURL(this.url),this.createTrack(`metadata`,e),e))).catch(e=>{throw n.innerHTML=``,t.show=e,e})}},Yn=class e{constructor(e){this.art=e;let{option:t,constructor:n}=e;t.container instanceof Element?this.$container=t.container:(this.$container=w(t.container),I(this.$container,`No container element found by ${t.container}`)),I(he(),`The current browser does not support flex layout`);let r=this.$container.tagName.toLowerCase();I(r===`div`,`Unsupported container element type, only support 'div' but got '${r}'`),I(n.instances.every(e=>e.template.$container!==this.$container),`Cannot mount multiple instances on the same dom element`),this.query=this.query.bind(this),this.$container.dataset.artId=e.id,this.init()}static get html(){return`
        ...
        `}query(e){return w(e,this.$container)}init(){let{option:t}=this.art;if(t.useSSR||(this.$container.innerHTML=e.html),this.$player=this.query(`.art-video-player`),this.$video=this.query(`.art-video`),this.$track=this.query(`track`),this.$poster=this.query(`.art-poster`),this.$subtitle=this.query(`.art-subtitle`),this.$danmuku=this.query(`.art-danmuku`),this.$bottom=this.query(`.art-bottom`),this.$progress=this.query(`.art-progress`),this.$controls=this.query(`.art-controls`),this.$controlsLeft=this.query(`.art-controls-left`),this.$controlsCenter=this.query(`.art-controls-center`),this.$controlsRight=this.query(`.art-controls-right`),this.$layer=this.query(`.art-layers`),this.$loading=this.query(`.art-loading`),this.$notice=this.query(`.art-notice`),this.$noticeInner=this.query(`.art-notice-inner`),this.$mask=this.query(`.art-mask`),this.$state=this.query(`.art-state`),this.$setting=this.query(`.art-settings`),this.$info=this.query(`.art-info`),this.$infoPanel=this.query(`.art-info-panel`),this.$infoClose=this.query(`.art-info-close`),this.$contextmenu=this.query(`.art-contextmenus`),t.proxy){let e=t.proxy.call(this.art,this.art);I(e instanceof HTMLVideoElement||e instanceof HTMLCanvasElement,`Function 'option.proxy' needs to return 'HTMLVideoElement' or 'HTMLCanvasElement'`),fe(e,this.$video),e.className=`art-video`,this.$video=e}t.backdrop&&E(this.$player,`art-backdrop`),S&&E(this.$player,`art-mobile`)}destroy(e){e?this.$container.innerHTML=``:E(this.$player,`art-destroy`)}},Xn=class{on(e,t,n){let r=this.e||(this.e={});return(r[e]||(r[e]=[])).push({fn:t,ctx:n}),this}once(e,t,n){let r=this;function i(...a){r.off(e,i),t.apply(n,a)}return i._=t,this.on(e,i,n)}emit(e,...t){let n=((this.e||(this.e={}))[e]||[]).slice();for(let e=0;e<n.length;e+=1)n[e].fn.apply(n[e].ctx,t);return this}off(e,t){let n=this.e||(this.e={}),r=n[e],i=[];if(r&&t)for(let e=0,n=r.length;e<n;e+=1)r[e].fn!==t&&r[e].fn._!==t&&i.push(r[e]);return i.length?n[e]=i:delete n[e],this}},Zn=0,Qn=[],$=class e extends Xn{constructor(t,n){if(super(),!C)throw Error(`Artplayer can only be used in the browser environment`);this.id=++Zn;let r=Te(e.option,t);if(r.container=t.container,this.option=y(r,Fe),this.isLock=!1,this.isReady=!1,this.isFocus=!1,this.isInput=!1,this.isRotate=!1,this.isDestroy=!1,this.template=new Yn(this),this.events=new dt(this),this.storage=new Kn(this),this.icons=new Ht(this),this.i18n=new mt(this),this.notice=new qt(this),this.player=new Pn(this),this.layers=new Wt(this),this.controls=new et(this),this.contextmenu=new He(this),this.subtitle=new Jn(this),this.info=new Ut(this),this.loading=new Gt(this),this.hotkey=new ft(this),this.mask=new Kt(this),this.setting=new Gn(this),this.plugins=new Bn(this),typeof n==`function`&&this.on(`ready`,()=>n.call(this,this)),e.DEBUG){let t=e=>console.log(`[ART.${this.id}] -> ${e}`);t(`Version@${e.version}`);for(let e=0;e<b.events.length;e++)this.on(`video:${b.events[e]}`,e=>t(`Event@${e.type}`))}Qn.push(this)}static get instances(){return Qn}static get version(){return re}static get config(){return b}static get utils(){return Me}static get scheme(){return Fe}static get Emitter(){return Xn}static get validator(){return y}static get kindOf(){return y.kindOf}static get html(){return Yn.html}static get option(){return{id:``,container:`#artplayer`,url:``,poster:``,type:``,theme:`#f00`,volume:.7,isLive:!1,muted:!1,autoplay:!1,autoSize:!1,autoMini:!1,loop:!1,flip:!1,playbackRate:!1,aspectRatio:!1,screenshot:!1,setting:!1,hotkey:!0,pip:!1,mutex:!0,backdrop:!0,fullscreen:!1,fullscreenWeb:!1,subtitleOffset:!1,miniProgressBar:!1,useSSR:!1,playsInline:!0,lock:!1,gesture:!0,fastForward:!1,autoPlayback:!1,autoOrientation:!1,airplay:!1,proxy:void 0,layers:[],contextmenu:[],controls:[],settings:[],quality:[],highlight:[],plugins:[],thumbnails:{url:``,number:60,column:10,width:0,height:0,scale:1},subtitle:{url:``,type:``,style:{},name:``,escape:!0,encoding:`utf-8`,onVttLoad:e=>e},moreVideoAttr:{controls:!1,preload:ie?`auto`:`metadata`},i18n:{},icons:{},cssVar:{},customType:{},lang:navigator?.language.toLowerCase()}}get proxy(){return this.events.proxy}get query(){return this.template.query}get video(){return this.template.$video}reset(){this.video.removeAttribute(`src`),this.video.load()}destroy(t=!0){e.REMOVE_SRC_WHEN_DESTROY&&this.reset(),this.events.destroy(),this.template.destroy(t),Qn.splice(Qn.indexOf(this),1),this.isDestroy=!0,this.emit(`destroy`)}};$.STYLE=qn,$.DEBUG=!1,$.CONTEXTMENU=!0,$.NOTICE_TIME=2e3,$.SETTING_WIDTH=250,$.SETTING_ITEM_WIDTH=200,$.SETTING_ITEM_HEIGHT=35,$.RESIZE_TIME=200,$.SCROLL_TIME=200,$.SCROLL_GAP=50,$.AUTO_PLAYBACK_MAX=10,$.AUTO_PLAYBACK_MIN=5,$.AUTO_PLAYBACK_TIMEOUT=3e3,$.RECONNECT_TIME_MAX=5,$.RECONNECT_SLEEP_TIME=1e3,$.CONTROL_HIDE_TIME=3e3,$.DBCLICK_TIME=300,$.DBCLICK_FULLSCREEN=!0,$.MOBILE_DBCLICK_PLAY=!0,$.MOBILE_CLICK_PLAY=!1,$.AUTO_ORIENTATION_TIME=200,$.INFO_LOOP_TIME=1e3,$.FAST_FORWARD_VALUE=3,$.FAST_FORWARD_TIME=1e3,$.TOUCH_MOVE_RATIO=.5,$.VOLUME_STEP=.1,$.SEEK_STEP=5,$.PLAYBACK_RATE=[.5,.75,1,1.25,1.5,2],$.ASPECT_RATIO=[`default`,`4:3`,`16:9`],$.FLIP=[`normal`,`horizontal`,`vertical`],$.FULLSCREEN_WEB_IN_BODY=!0,$.LOG_VERSION=!0,$.USE_RAF=!1,$.REMOVE_SRC_WHEN_DESTROY=!0,C&&(me(`artplayer-style`,qn),setTimeout(()=>{$.LOG_VERSION&&console.log(`%c ArtPlayer %c ${$.version} %c https://artplayer.org`,`color: #fff; background: #5f5f5f`,`color: #fff; background: #4bc729`,``)},100)),$.PLAYBACK_RATE=[.5,.75,1,1.25,1.5,2,3,4];var $n=[{icon:`iina`,name:`IINA`,scheme:`iina://weblink?url=$edurl`},{icon:`potplayer`,name:`PotPlayer`,scheme:`potplayer://$durl`},{icon:`vlc`,name:`VLC`,scheme:`vlc://$durl`},{icon:`nplayer`,name:`nPlayer`,scheme:`nplayer-$durl`},{icon:`omniplayer`,name:`OmniPlayer`,scheme:`omniplayer://weblink?url=$durl`},{icon:`figplayer`,name:`Fig Player`,scheme:`figplayer://weblink?url=$durl`},{icon:`infuse`,name:`Infuse`,scheme:`infuse://x-callback-url/play?url=$durl`},{icon:`fileball`,name:`Fileball`,scheme:`filebox://play?url=$durl`},{icon:`mxplayer`,name:`MX Player`,scheme:`intent:$durl#Intent;package=com.mxtech.videoplayer.ad;S.title=$name;end`},{icon:`mxplayer-pro`,name:`MX Player Pro`,scheme:`intent:$durl#Intent;package=com.mxtech.videoplayer.pro;S.title=$name;end`},{icon:`iPlay`,name:`iPlay`,scheme:`iplay://play/any?type=url&url=$bdurl`},{icon:`mpv`,name:`mpv`,scheme:`mpv://$edurl`}],er=e=>{let{$container:t,$video:n}=e.template,r=t.parentElement;e.on(`ready`,()=>{r.style.maxHeight=`calc(100vh - ${r.offsetTop}px - 1.75rem)`,r.style.minHeight=`320px`,e.autoHeight()}),e.on(`resize`,()=>{e.autoHeight()}),e.on(`error`,()=>{n.style.height||(t.style.height=`60vh`,n.style.height=`100%`)})},tr=g=>{let{replace:_}=e(),{currentObjLink:te}=a(),v=o.objs.filter(e=>e.type===f.VIDEO);v.length===0&&(v=[o.obj]);let ne=i(),y=localStorage.getItem(`video_auto_next`);return y||(y=`true`),g.onAutoNextChange(y===`true`),r(d,{w:`$full`,spacing:`$2`,get children(){return[s(()=>g.children),r(l,{spacing:`$2`,w:`$full`,get children(){return[r(c,{onChange:e=>{_(e)},get value(){return o.obj.name},get options(){return v.map(e=>({value:e.name}))}}),r(h,{defaultChecked:y===`true`,onChange:e=>{g.onAutoNextChange(e),localStorage.setItem(`video_auto_next`,e.toString())},get children(){return ne(`home.preview.auto_next`)}})]}}),r(u,{wrap:`wrap`,gap:`$1`,justifyContent:`center`,get children(){return r(t,{each:$n,children:e=>r(ee,{placement:`top`,withArrow:!0,get label(){return e.name},get children(){return r(p,{get href(){return n(e.scheme,{raw_url:o.raw_url,name:o.obj.name,d_url:te(!0)})},get children(){return r(m,{m:`0 auto`,boxSize:`$8`,get src(){return`${window.__dynamic_base__}/images/${e.icon}.webp`}})}})}})})}})]}})};export{$ as i,tr as n,$n as r,er as t};